<section class="page" id="page-book" data-page="book">
    <div class="section">
        <div class="wrap">
            ...
            <p class="rating-line">{{ $site['heroFacts'][5]['label'] ?? 'All 5 star reviews from more than 30 Airbnb guests within the first year of listing' }}</p>
            <ul class="platforms">
                        ...
                        <div class="row">
                            <label>Phone
                                <span class="phone-row">
                                    <select name="phone_code" aria-label="Country dial code">
