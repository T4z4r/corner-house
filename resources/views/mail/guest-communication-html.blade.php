                            ...
                            <tr>
                                <td align="center" style="padding:36px 40px 10px 40px;">
                                    <a href="{{ $brandUrl }}" style="text-decoration:none;">
                                        <img src="{{ $message->embed(public_path('images/brand/logo-email.png')) }}" alt="{{ $brandName }}, Braunston" width="120" height="80" style="display:block; width:120px; height:auto; border:0; outline:none; text-decoration:none;">
                                    </a>
                                </td>
                            </tr>
                            <tr>
