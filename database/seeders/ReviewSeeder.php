...
class ReviewSeeder extends Seeder
{
    public function run(): void
    {
        $reviews = [
            ...
            ['stars' => 5, 'quote' => 'We organised a birthday weekend here and the whole gathering was looked after brilliantly. The rooms are huge and each one having its own bathroom is a treat.', 'cite' => 'James, March 2026', 'status' => Review::STATUS_APPROVED, 'sort_order' => 5],
