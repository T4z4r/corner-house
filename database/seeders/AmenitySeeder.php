...
class AmenitySeeder extends Seeder
{
    public function run(): void
    {
        $amenities = [
            ...
            ['name' => 'Orangery dining room', 'icon' => 'bi-archive', 'category' => 'The house', 'description' => 'A dining room in the orangery seating ten at a handmade farmhouse table.', 'is_active' => true],
