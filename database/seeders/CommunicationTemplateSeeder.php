...
The hot tub is on and ready for use at 40°C. You're welcome to adjust the temperature, and there are spare chemicals on the rack. The Kadai BBQ and outdoor seating is opposite and the fire pit and additional seating are up the steps, by the lawn.
...
GYM
The gym is used entirely at your own and your guests' own risk. The key is on the kitchen counter on top of a liability waiver — please read this before use. There's a Google speaker in there: say "Hey Google" and ask it to play YouTube Music or whatever you would like.
