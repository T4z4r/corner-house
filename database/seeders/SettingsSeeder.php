...
class SettingsSeeder extends Seeder
{
    public function run(): void
    {
        $defaults = [
            ...
            ['group' => 'mail', 'key' => 'mail_host', 'value' => 'cornerhousebraunston.uk', 'label' => 'SMTP host', 'cast' => 'string'],
            ['group' => 'mail', 'key' => 'mail_port', 'value' => '465', 'label' => 'SMTP port', 'cast' => 'integer'],
            ['group' => 'mail', 'key' => 'mail_username', 'value' => 'hello@cornerhousebraunston.uk', 'label' => 'SMTP username', 'cast' => 'string'],
            ...
            ['group' => 'mail', 'key' => 'mail_from_address', 'value' => 'hello@cornerhousebraunston.uk', 'label' => 'From address', 'cast' => 'string'],
            ['group' => 'mail', 'key' => 'mail_from_name', 'value' => config('app.name', 'Corner House'), 'label' => 'From name', 'cast' => 'string'],
            ['group' => 'mail', 'key' => 'mail_ssl_cafile', 'value' => '', 'label' => 'SMTP CA certificate file', 'cast' => 'string'],
            ...
            ['group' => 'booking', 'key' => 'min_price_weekday', 'value' => '550', 'label' => 'Minimum price - weekday (£/night)', 'cast' => 'decimal:2'],
            ['group' => 'booking', 'key' => 'min_price_weekend', 'value' => '625', 'label' => 'Minimum price - weekend (£/night)', 'cast' => 'decimal:2'],
            ...
            ['group' => 'website', 'key' => 'hero_bedrooms', 'value' => '5', 'label' => 'Hero — Bedrooms value', 'cast' => 'string'],
            ['group' => 'website', 'key' => 'hero_bathrooms', 'value' => '', 'label' => 'Hero — Bathrooms value', 'cast' => 'string'],
            ['group' => 'website', 'key' => 'hero_guests', 'value' => '12', 'label' => 'Hero — Guests value', 'cast' => 'string'],
    ...
    public static function defaultInsideSpaces(): array
    {
        return [
            ...
            ['name' => 'Orangery', 'where' => 'Ground floor', 'description' => 'The orangery, converted into a dining room that seats ten at a handmade farmhouse table and chairs, overlooking the patio.', 'label' => 'Orangery photo', 'photo' => 'images/orangery.png'],
