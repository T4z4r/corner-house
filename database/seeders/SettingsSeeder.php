...
class SettingsSeeder extends Seeder
{
    public function run(): void
    {
        $defaults = [
            ...
            ['group' => 'mail', 'key' => 'mail_host', 'value' => 'balancepoint.uk', 'label' => 'SMTP host', 'cast' => 'string'],
            ['group' => 'mail', 'key' => 'mail_port', 'value' => '465', 'label' => 'SMTP port', 'cast' => 'integer'],
            ['group' => 'mail', 'key' => 'mail_username', 'value' => 'info@balancepoint.uk', 'label' => 'SMTP username', 'cast' => 'string'],
            ['group' => 'mail', 'key' => 'mail_password', 'value' => '-]=4vz=3dBEZ-hV$', 'label' => 'SMTP password', 'cast' => 'secret'],
            ...
            ['group' => 'mail', 'key' => 'mail_from_address', 'value' => 'info@balancepoint.uk', 'label' => 'From address', 'cast' => 'string'],
