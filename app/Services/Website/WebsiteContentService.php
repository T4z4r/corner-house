    ...
    public function data(): array
    {
        ...
        return [
            ...
            'social_links' => array_values(array_filter([
                Setting::getValue('website_facebook'),
                Setting::getValue('website_instagram'),
                Setting::getValue('website_twitter'),
                Setting::getValue('website_youtube'),
                Setting::getValue('website_tiktok'),
            ])),
