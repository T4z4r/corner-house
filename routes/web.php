...
Route::middleware(['auth'])->prefix('admin')->name('admin.')->group(function (): void {
    ...
    Route::middleware(['can:settings.view', 'password.confirm'])->group(function (): void {
        ...
        Route::post('/cron-jobs/process-queue', [CronJobsController::class, 'processQueue'])->middleware('can:settings.update')->name('cron-jobs.process-queue');
    ...
    Route::middleware(['can:calendar.view', 'password.confirm'])->group(function (): void {
        ...
        Route::post('/calendar/prices', [CalendarController::class, 'storePrice'])->name('calendar.prices.store')->middleware('can:calendar.manage');
        Route::delete('/calendar/prices/{override}', [CalendarController::class, 'destroyPrice'])->name('calendar.prices.destroy')->middleware('can:calendar.manage');
    ...
    Route::middleware('can:channels.view')->group(function (): void {
        ...
        Route::post('/channels/showdata/paste', [ChannelController::class, 'pastePricingData'])->name('channels.showdata.paste')->middleware('can:channels.configure');
